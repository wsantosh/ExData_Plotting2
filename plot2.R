...
names(totalBaltimoreEmissionsData) <- c("Year", "Total PM2.5 Emission(Tons)")
...
plot(totalBaltimoreEmissionsData, col = "red", type="l", main="Total PM2.5 Emissions in Baltimore City", lwd=2)
